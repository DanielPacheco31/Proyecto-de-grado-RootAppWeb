    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('foto', models.ImageField(default='perfiles/default.png', upload_to='perfiles/', verbose_name='Foto de perfil')),
                ('telefono', models.CharField(blank=True, max_length=15, verbose_name='Teléfono')),
                ('direccion', models.TextField(blank=True, verbose_name='Dirección')),
                ('fecha_nacimiento', models.DateField(blank=True, null=True, verbose_name='Fecha de nacimiento')),
                ('id_documento', models.CharField(blank=True, max_length=20, verbose_name='Documento de identidad')),
